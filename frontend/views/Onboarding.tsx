                    ...
                    {data.exams.map(e => (
                      <div key={e} className="flex items-center justify-between mb-3 last:mb-0">
                        ...
                        <input
                          type="text"
                          placeholder="Score"
                          className="w-24 p-2 text-center text-sm font-bold bg-white/60 border border-white/80 rounded-lg outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all backdrop-blur-sm"
                        />
                      </div>
                    ))}
                  </div>
